#!/usr/bin/env python3
"""Render the exported arena in Blender/Cycles. Run inside Blender, not python.
...
def main():
    ...
    sc.view_settings.view_transform = ("AgX" if "AgX" in names else
                                       "Filmic" if "Filmic" in names else "Standard")
