...
def camera_track(pos: np.ndarray, zone: list[str], duration: float, fps: int,
    ...
    # 0-6s   high wide: all three zones at once
    add(0.0, [-2.0, -28.0, 16.5], [0.0, 1.0, 1.1], 46.0)
    add(6.0, [ 1.5, -25.0, 14.5], [0.0, 1.0, 1.1], 45.0)
    ...
    add(52.0, [ 2.0, -17.0, 8.0], [0.0, 0.5, 1.2], 43.0)
    # 55-60s  final crane up and back: the commander overlooking the facility
    add(56.5, [ 0.5, -24.0, 13.0], [0.0, 1.0, 1.1], 45.0)
    add(60.0, [-1.0, -31.0, 18.5], [0.0, 1.5, 1.0], 47.0)
